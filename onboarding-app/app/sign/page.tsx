...
export default function SignPage() {
    ...
    useEffect(() => {
        ...
        // Build document list based on partner type
        ...
        // Simulate DocuSign envelope loading
    ...
    const handleSignAll = () => {
        ...
        // Simulate DocuSign signing process with progressive document signing
        let index = 0;
        const signInterval = setInterval(() => {
            if (index < documents.length) {
                setDocuments(prev =>
                    prev.map((doc, i) =>
                        i === index ? { ...doc, status: 'signed' } : doc
                    )
                );
                ...
                // Redirect to success after signing
                    ...
                    <div className="bg-white/95 border border-slate-200 rounded-2xl p-8 shadow-lg">
                        <div className="text-center mb-6">
                            ...
                            <p className="text-sm text-slate-500 mt-2">
                                Signing document {currentDocIndex + 1} of {documents.length}
                            </p>
                        </div>
